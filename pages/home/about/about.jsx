...
let styles = {
  ...
  spacebtw: "mt-8",
  title2: "text-xl pb-20 lg:text-6xl font-montez text-pink-500 hover:scale-110 hover:ease-in hover:duration-300",
    ...
    <div class="flex flex-wrap -m-2">
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        ...
        <Image src={php} alt="php" className={styles.img} height="70" width="60"/>
          <div class="flex-grow">
            ...
            <p className="ml-4 text-gray-200 title-font font-medium">MySQL</p>
          </div>
        </div>
      </div>
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        ...
        <Image src={tailwind} alt="tailwind" className={styles.img}/>
          <div class="flex-grow">
            <h2 class="text-gray-200 title-font font-medium ml-4">TAILWIND CSS</h2>
          </div>
        </div>
      </div>
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        ...
        <Image src={react} alt="react" className={styles.img} height="60" width="60" />
          <div class="flex-grow">
            ...
            <p class="text-gray-200 title-font font-medium ml-4">REACT.JS</p>
            <p class="text-gray-200 title-font font-medium ml-4">NEXT.JS</p>
          </div>
        </div>
      </div>
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        ...
        <Image src={symfony} alt="symfony" className={styles.img2} height="60" width="60"/>
          <div class="flex-grow">
            ...
            <p class="text-gray-200 title-font font-medium ml-4">EXPRESS.JS</p>
          </div>
        </div>
      </div>
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
