...
let styles = {
  ...
  section: "mb-32 text-gray-800",
  divform: "relative overflow-hidden bg-no-repeat bg-cover",
  // bgimg: "background-position: 50%; background-image: url('https://img.freepik.com/free-vector/empty-underwater-blue-shine-abstract-background-light-bright-clean-ocean-sea_1284-42065.jpg?w=2000&t=st=1668519351~exp=1668519951~hmac=51064da02084d3feead3f494b792a2c4cebd64f50f5d736763d59441bb402697'); height: 300px;"
};
...
const Contacts = () => {
  return (
    ...
    <div className={styles.formdiv} style={{ "--background-position" : 50%}}>
    </div>
      ...
      <div class="block rounded-lg shadow-lg py-10 md:py-12 px-4 md:px-6"
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 mb-12">
          ...
          <div class="mb-12 lg:mb-0 text-center mx-auto">
            ...
            <h6 class="font-medium">Meaux, 77100</h6>
          </div>
          <div class="mb-6 md:mb-0 text-center mx-auto">
            ...
            <h6 class="font-medium">+33 07.86.80.56.91</h6>
          </div>
          <div class="text-center mx-auto">
            ...
            <h6 class="font-medium">find sometin' to add</h6>
          </div>
        </div>
          ...
          <form>
            ...
            <div class="form-group mb-6">
              ...
              focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput8"
                placeholder="addresse email"></input>
            </div>
            <div class="form-group mb-6">
              <textarea class="
              form-control
            ...
            <div class="form-group form-check text-center mb-6">
              ...
              <label class="form-check-label inline-block text-gray-800" for="exampleCheck87">Envoyez moi une copie de ce message</label>
            </div>
